...
namespace LazyMagic
{
    public static class AwsServiceApiLambdasResources
    {
        /// <summary>
        ...
        public static string GenerateApiLambdaResources(SolutionBase solution, DirectiveBase serviceDirectiveArg)
        {
            try
            {
            ...
            {
                throw new Exception($"Error generating {nameof(AwsServiceApiLambdasResources)} : {ex.Message}");
            }
        }
