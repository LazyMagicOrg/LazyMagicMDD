...
namespace LazyMagic
{
    public class AwsWebAppStackResource : ArtifactBase
    {
        ...
        {
            WebApp directive = (WebApp)directiveArg;
            ...
            var template = Template ?? "AWSTemplates/Snippets/sam.service.webapp.yaml";
